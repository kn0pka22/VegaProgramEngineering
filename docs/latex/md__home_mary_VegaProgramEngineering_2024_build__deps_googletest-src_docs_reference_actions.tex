...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md317}{}\doxysection{Side Effects}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md317}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md318}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md318}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md319}{}\doxysection{Default Action}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md319}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md320}{}\doxysection{Composite Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md320}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md321}{}\doxysection{Defining Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_actions_autotoc_md321}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
