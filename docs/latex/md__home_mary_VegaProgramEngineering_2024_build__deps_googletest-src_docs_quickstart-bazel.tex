This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md306}{}\doxysection{Prerequisites}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md306}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md307}{}\doxysection{Set up a Bazel workspace}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md307}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md308}{}\doxysection{Create and run a binary}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md308}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md309}{}\doxysection{Next steps}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_quickstart-bazel_autotoc_md309}
