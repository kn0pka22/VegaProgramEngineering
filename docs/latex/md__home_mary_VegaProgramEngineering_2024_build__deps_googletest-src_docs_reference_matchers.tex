...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \+::testing} namespace unless otherwise noted.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md324}{}\doxysection{Wildcard}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md324}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md325}{}\doxysection{Generic Comparison}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md325}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+R\+UE} and {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+F\+A\+L\+SE}}} assertions.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_FpMatchers}{}\doxysection{Floating-\/\+Point Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md326}{}\doxysection{String Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md326}
...
{\ttfamily When\+Base64\+Unescaped(m)} &{\ttfamily argument} is a base-\/64 escaped string whose unescaped string matches {\ttfamily m}. The web-\/safe format from \href{https://www.rfc-editor.org/rfc/rfc4648\#section-5}{\texttt{ R\+FC 4648}} is supported.  \\\cline{1-2}
\end{longtabu}


{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md327}{}\doxysection{Container Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md327}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md328}{}\doxysection{Member Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md328}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md329}{}\doxysection{Matching the Result of a Function, Functor, or Callback}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md329}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md330}{}\doxysection{Pointer Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md330}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_MultiArgMatchers}{}\doxysection{Multi-\/argument Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md331}{}\doxysection{Composite Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md331}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md332}{}\doxysection{Adapters for Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md332}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_MatchersAsPredicatesCheat}{}\doxysection{Using Matchers as Predicates}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md333}{}\doxysection{Defining Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_matchers_autotoc_md333}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
