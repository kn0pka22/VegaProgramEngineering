\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md182}{}\doxysection{Defining a Mock Class}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md182}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MockClass}{}\doxysubsection{Mocking a Normal Class}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MockClass}
Given
...
\{\+: .callout .note\} {\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MockTemplate}{}\doxysubsection{Mocking a Class Template}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MockTemplate}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md183}{}\doxysubsection{Specifying Calling Conventions for Mock Functions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md183}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_UsingMocks}{}\doxysection{Using Mocks in Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_UsingMocks}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_OnCall}{}\doxysection{Setting Default Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{ {\ttfamily O\+N\+\_\+\+C\+A\+LL}}}. {\ttfamily O\+N\+\_\+\+C\+A\+LL} has a similar syntax to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{ Knowing When to Expect}} for a more detailed discussion.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_ExpectCall}{}\doxysection{Setting Expectations}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}}} in the Mocking Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MatcherList}{}\doxysection{Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_MatcherList}
See the Matchers Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_ActionList}{}\doxysection{Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_ActionList}
See the Actions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_CardinalityList}{}\doxysection{Cardinalities}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_CardinalityList}
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL} in the Mocking Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md184}{}\doxysection{Expectation Order}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md184}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md185}{}\doxysection{Verifying and Resetting a Mock}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md185}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md186}{}\doxysection{Mock Classes}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md186}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md187}{}\doxysection{Flags}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cheat_sheet_autotoc_md187}
\tabulinesep=1mm
