...
\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md189}{}\doxysection{Creating Mock Classes}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md189}
Mock classes are defined as normal classes, using the {\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} macro to generate mocked methods. The macro gets 3 or 4 parameters\+:
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md190}{}\doxysubsection{Dealing with unprotected commas}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md190}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md191}{}\doxysubsection{Mocking Private or Protected Methods}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md191}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md192}{}\doxysubsection{Mocking Overloaded Methods}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md192}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md193}{}\doxysubsection{Mocking Class Templates}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md193}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md194}{}\doxysubsection{Mocking Free Functions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md194}
...
Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \href{\#MockFunction}{\texttt{ Mock\+Function}} to mock the std\+::function.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md195}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+O\+Dn$<$/tt$>$ Macros}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md195}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NiceStrictNaggy}
...
If a method of {\ttfamily mock\+\_\+foo} other than {\ttfamily Do\+This()} is called, you will get a warning. However, if you rewrite your test to use {\ttfamily Nice\+Mock$<$Mock\+Foo$>$} instead, you can suppress the warning\+:
...
\begin{DoxyEnumerate}
\item {\ttfamily Nice\+Mock$<$Mock\+Foo$>$} and {\ttfamily Strict\+Mock$<$Mock\+Foo$>$} only work for mock methods defined using the {\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} macro {\bfseries{directly}} in the {\ttfamily Mock\+Foo} class. If a mock method is defined in a {\bfseries{base class}} of {\ttfamily Mock\+Foo}, the \char`\"{}nice\char`\"{} or \char`\"{}strict\char`\"{} modifier may not affect it, depending on the compiler. In particular, nesting {\ttfamily Nice\+Mock} and {\ttfamily Strict\+Mock} (e.\+g. {\ttfamily Nice\+Mock$<$Strict\+Mock$<$Mock\+Foo$>$ $>$}) is {\bfseries{not}} supported.
\item {\ttfamily Nice\+Mock$<$Mock\+Foo$>$} and {\ttfamily Strict\+Mock$<$Mock\+Foo$>$} may not work correctly if the destructor of {\ttfamily Mock\+Foo} is not virtual. We would like to fix this, but it requires cleaning up existing tests.
\end{DoxyEnumerate}

Finally, you should be {\bfseries{very cautious}} about when to use naggy or strict mocks, as they tend to make tests more brittle and harder to maintain. When you refactor your code without changing its externally visible behavior, ideally you shouldn\textquotesingle{}t need to update any tests. If your code interacts with a naggy mock, however, you may start to get spammed with warnings as the result of your change. Worse, if your code interacts with a strict mock, your tests may start to fail and you\textquotesingle{}ll be forced to fix them. Our general recommendation is to use nice mocks (not yet the default) most of the time, use naggy mocks (the current default) when developing or debugging tests, and use strict mocks only as the last resort.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SimplerInterfaces}{}\doxysubsection{Simplifying the Interface without Breaking Existing Code}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SimplerInterfaces}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md196}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md196}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_DelegatingToFake}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md197}{}\doxysubsection{Delegating Calls to a Real Object}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md197}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md199}{}\doxysection{Using Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md199}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md200}{}\doxysubsection{Matching Argument Values Exactly}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md200}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md201}{}\doxysubsection{Using Simple Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md201}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SelectOverload}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md202}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md202}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md203}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md203}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate M\+U\+ST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md204}{}\doxysubsection{Using Matchers as Predicates}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md204}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md205}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md205}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT}}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md206}{}\doxysubsection{Using Predicates as Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md206}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md207}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md207}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md208}{}\doxysubsection{Validating a Member of an Object}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md208}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md209}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md209}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_CustomMatcherClass}{}\doxysubsection{Defining a Custom Matcher Class}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_CustomMatcherClass}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md210}{}\doxysubsection{Matching Containers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md210}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md211}{}\doxysubsection{Sharing Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md211}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md212}{}\doxysection{Setting Expectations}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md212}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_UseOnCall}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md214}{}\doxysubsection{Disallowing Unexpected Calls}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md214}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#NiceStrictNaggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_ParameterlessExpectations}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md215}{}\doxysubsection{Controlling When an Expectation Retires}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md215}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md216}{}\doxysection{Using Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md216}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md217}{}\doxysubsection{Returning References from Mock Methods}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md217}
...
\DoxyCodeLine{...}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md218}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md218}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md219}{}\doxysubsection{Combining Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md219}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md220}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md220}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md221}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md221}
...
precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}s have their own precedence order distinct from the {\ttfamily O\+N\+\_\+\+C\+A\+LL} precedence order.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md222}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md222}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md223}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md223}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md224}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md224}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md225}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md225}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md226}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md226}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md227}{}\doxysubsection{Sharing Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md227}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md228}{}\doxysubsection{Testing Asynchronous Behavior}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md228}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md229}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md229}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md230}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md230}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md231}{}\doxysubsection{Making the Compilation Faster}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md231}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md232}{}\doxysubsection{Forcing a Verification}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md232}
...
And that\textquotesingle{}s that.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md234}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md234}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md235}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md235}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md236}{}\doxysubsection{Running Tests in Emacs}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md236}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md237}{}\doxysection{Extending g\+Mock}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md237}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewMatchers}
...
For convenience, we allow the description string to be empty ({\ttfamily \char`\"{}\char`\"{}}), in which case g\+Mock will use the sequence of words in the matcher name as the description.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md238}{}\doxysubsubsection{Basic Example}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md238}
...
where the descriptions {\ttfamily \char`\"{}is divisible by 7\char`\"{}} and {\ttfamily \char`\"{}not (is divisible by 7)\char`\"{}} are automatically calculated from the matcher name {\ttfamily Is\+Divisible\+By7}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md239}{}\doxysubsubsection{Adding Custom Failure Messages}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md239}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md240}{}\doxysubsubsection{Using E\+X\+P\+E\+C\+T\+\_\+ Statements in Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md240}
You can also use {\ttfamily E\+X\+P\+E\+C\+T\+\_\+...} (and {\ttfamily A\+S\+S\+E\+R\+T\+\_\+...}) statements inside custom matcher definitions. In many cases, this allows you to write your matcher more concisely while still providing an informative error message. For example\+:
...
If you write a test that includes the line {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+A\+T(27, Is\+Divisible\+By7());}, you will get an error something like the following\+:
...
\DoxyCodeLine{  0}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md241}{}\doxysubsubsection{$<$tt$>$\+Match\+And\+Explain$<$/tt$>$}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md241}
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily Not()}. There is no need to print the argument value itself, as g\+Mock already prints it for you.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md242}{}\doxysubsubsection{Argument Types}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md242}
The type of the value being matched ({\ttfamily arg\+\_\+type}) is determined by the context in which you use the matcher and is supplied to you by the compiler, so you don\textquotesingle{}t need to worry about declaring it (nor can you). This allows the matcher to be polymorphic. For example, {\ttfamily Is\+Divisible\+By7()} can be used to match any type where the value of {\ttfamily (arg \% 7) == 0} can be implicitly converted to a {\ttfamily bool}. In the {\ttfamily Bar(\+Is\+Divisible\+By7())} example above, if method {\ttfamily Bar()} takes an {\ttfamily int}, {\ttfamily arg\+\_\+type} will be {\ttfamily int}; if it takes an {\ttfamily unsigned long}, {\ttfamily arg\+\_\+type} will be {\ttfamily unsigned long}; and so on.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md243}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md243}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md245}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md245}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md246}{}\doxysubsection{Legacy Matcher Implementation}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md246}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md247}{}\doxysubsection{Writing New Cardinalities}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md247}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md248}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md248}
...
\end{longtabu}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md249}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md249}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md250}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md250}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md251}{}\doxysubsection{Writing New Action Templates Quickly}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md251}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md252}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md252}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md253}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md253}
...
This printer knows how to print built-\/in C++ types, native arrays, S\+TL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md254}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_autotoc_md254}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_cook_book_MockFunction}
