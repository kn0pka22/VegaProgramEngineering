\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md82}{}\doxysection{Introduction}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md82}
Now that you have read the Google\+Test Primer and learned how to write tests using Google\+Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md83}{}\doxysection{More Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md83}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md84}{}\doxysubsection{Explicit Success and Failure}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md84}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md85}{}\doxysubsection{Exception Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md85}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md86}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md86}
...
Google\+Test gives you three different options to solve this problem\+:\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md87}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md87}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} in the Assertions Reference for details.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md88}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md88}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md89}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md89}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+R\+UE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D\+\_\+\+F\+O\+R\+M\+A\+T$\ast$}}} in the Assertions Reference for details.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md90}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md90}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md91}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md91}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md92}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md92}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT}}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md93}{}\doxysubsection{More String Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md93}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md94}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md94}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows H\+R\+E\+S\+U\+LT Assertions}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md95}{}\doxysubsection{Type Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md95}
...
to cause a compiler error.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md96}{}\doxysubsection{Assertion Placement}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md96}
...
\{\+: .callout .warning\} W\+A\+R\+N\+I\+NG\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md97}{}\doxysection{Skipping test execution}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md97}
...
As with assertion macros, you can stream a custom message into {\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md98}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md98}
...
For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md99}{}\doxysection{Death Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md99}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md100}{}\doxysubsection{How to Write a Death Test}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md100}
...
In particular, if {\ttfamily statement} generates an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} or {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md101}{}\doxysubsection{Death Test Naming}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md101}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md102}{}\doxysubsection{Regular Expression Syntax}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md102}
When built with Bazel and using Abseil, Google\+Test uses the \href{https://github.com/google/re2/wiki/Syntax}{\texttt{ R\+E2}} syntax. Otherwise, for P\+O\+S\+IX systems (Linux, Cygwin, Mac), Google\+Test uses the \href{https://www.opengroup.org/onlinepubs/009695399/basedefs/xbd_chap09.html\#tag_09_04}{\texttt{ P\+O\+S\+IX extended regular expression}} syntax. To learn about P\+O\+S\+IX syntax, you may want to read this \href{https://en.wikipedia.org/wiki/Regular_expression\#POSIX_extended}{\texttt{ Wikipedia entry}}.
...
To help you determine which capability is available on your system, Google\+Test defines macros to govern which regular expression it is using. The macros are\+: {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+S\+I\+M\+P\+L\+E\+\_\+\+RE=1} or {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+P\+O\+S\+I\+X\+\_\+\+RE=1}. If you want your death tests to work in all cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md103}{}\doxysubsection{How It Works}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md103}
See \href{reference/assertions.md\#death}{\texttt{ Death Assertions}} in the Assertions Reference.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md104}{}\doxysubsection{Death Tests And Threads}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md104}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md105}{}\doxysubsection{Death Test Styles}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md105}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md106}{}\doxysubsection{Caveats}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md106}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md107}{}\doxysection{Using Assertions in Sub-\/routines}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md107}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom G\+Mock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md108}{}\doxysubsection{Adding Traces to Assertions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md108}
...
\end{DoxyEnumerate}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md109}{}\doxysubsection{Propagating Fatal Failures}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md109}
...
To alleviate this, Google\+Test provides three different solutions. You could use either exceptions, the {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+N\+O\+\_\+\+F\+A\+T\+A\+L\+\_\+\+F\+A\+I\+L\+U\+RE} assertions or the {\ttfamily Has\+Fatal\+Failure()} function. They are described in the following two subsections.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md110}{}\doxysubsubsection{Asserting on Subroutines with an exception}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md110}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md111}{}\doxysubsubsection{Asserting on Subroutines}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md111}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md112}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md112}
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md113}{}\doxysection{Logging Additional Information}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md113}
...
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md114}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md114}
...
That\textquotesingle{}s it! Google\+Test automatically calls {\ttfamily Set\+Up\+Test\+Suite()} before running the {\itshape first test} in the {\ttfamily Foo\+Test} test suite (i.\+e. before creating the first {\ttfamily Foo\+Test} object), and calls {\ttfamily Tear\+Down\+Test\+Suite()} after running the {\itshape last test} in it (i.\+e. after deleting the last {\ttfamily Foo\+Test} object). In between, the tests can use the shared resources.
...
\{\+: .callout .note\} N\+O\+TE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily T\+E\+S\+T\+\_\+P}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md115}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md115}
...
Now, when {\ttfamily R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()} is invoked, it first calls the {\ttfamily Set\+Up()} method. The tests are then executed, provided that none of the environments have reported fatal failures and {\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()} has not been invoked. Finally, {\ttfamily Tear\+Down()} is called.

Note that {\ttfamily Set\+Up()} and {\ttfamily Tear\+Down()} are only invoked if there is at least one test to be performed. Importantly, {\ttfamily Tear\+Down()} is executed even if the test is not run due to a fatal failure or {\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}.
...
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md117}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md117}
...
For example, the following statement will instantiate tests from the {\ttfamily Foo\+Test} test suite each with parameter values {\ttfamily \char`\"{}meeny\char`\"{}}, {\ttfamily \char`\"{}miny\char`\"{}}, and {\ttfamily \char`\"{}moe\char`\"{}} using the \href{reference/testing.md\#param-generators}{\texttt{ {\ttfamily Values}}} parameter generator\+:
...
The following statement will instantiate all tests from {\ttfamily Foo\+Test} again, each with parameter values {\ttfamily \char`\"{}cat\char`\"{}} and {\ttfamily \char`\"{}dog\char`\"{}} using the \href{reference/testing.md\#param-generators}{\texttt{ {\ttfamily Values\+In}}} parameter generator\+:
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{https://github.com/google/googletest/blob/main/googletest/samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md118}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md118}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+S\+U\+I\+T\+E\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md119}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md119}
...
\DoxyCodeLine{    \});}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md120}{}\doxysection{Typed Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md120}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md121}{}\doxysection{Type-\/\+Parameterized Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md121}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md122}{}\doxysection{Testing Private Code}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md122}
...
class Foo\+Test \+: public \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}} \{ protected\+: ... \};

T\+E\+S\+T\+\_\+\+F(\+Foo\+Test, Bar) \{ ... \} T\+E\+S\+T\+\_\+\+F(\+Foo\+Test, Baz) \{ ... \}

\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md123}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md123}
...
\end{DoxyEnumerate}\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md124}{}\doxysection{Registering tests programmatically}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md124}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md125}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md125}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md126}{}\doxysection{Extending Google\+Test by Handling Test Events}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md126}
Google\+Test provides an {\bfseries{event listener A\+PI}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this A\+PI to augment or replace the standard console output, replace the X\+ML output, or provide a completely different form of output, such as a G\+UI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md127}{}\doxysubsection{Defining Event Listeners}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md127}
...
\DoxyCodeLine{ \};}
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md128}{}\doxysubsection{Using Event Listeners}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md128}
To use the event listener you have defined, add an instance of it to the Google\+Test event listener list (represented by class \href{reference/testing.md\#TestEventListeners}{\texttt{ {\ttfamily Test\+Event\+Listeners}}} -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily main()} function, before calling {\ttfamily R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}\+:
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md129}{}\doxysubsection{Generating Failures in Listeners}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md129}
...
See \href{https://github.com/google/googletest/blob/main/googletest/samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md130}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md130}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md131}{}\doxysubsection{Selecting Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md131}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md132}{}\doxysubsubsection{Listing Test Names}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md132}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md133}{}\doxysubsubsection{Running a Subset of the Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md133}
...
\item \`{}./foo\+\_\+test --gtest\+\_\+filter={\ttfamily Also runs everything, due to the single match-\/everything}$\ast${\ttfamily value. $\ast$}./foo\+\_\+test --gtest\+\_\+filter=Foo\+Test.$\ast${\ttfamily Runs everything in test suite }Foo\+Test{\ttfamily . $\ast$}./foo\+\_\+test --gtest\+\_\+filter=$\ast$\+Null$\ast$\+:{\itshape Constructor}{\ttfamily Runs any test whose full name contains either}\char`\"{}\+Null\char`\"{}{\ttfamily or}\char`\"{}\+Constructor\char`\"{}{\ttfamily . $\ast$}./foo\+\_\+test --gtest\+\_\+filter=-\/$\ast$\+Death\+Test.$\ast${\ttfamily Runs all non-\/death tests. $\ast$}./foo\+\_\+test --gtest\+\_\+filter=Foo\+Test.$\ast$-\/\+Foo\+Test.Bar{\ttfamily Runs everything in test suite}Foo\+Test{\ttfamily except}Foo\+Test.\+Bar$<$tt$>$. $\ast$./foo\+\_\+test --gtest\+\_\+filter=Foo\+Test.$\ast$\+:Bar\+Test.$\ast$-\/\+Foo\+Test.Bar\+:Bar\+Test.\+Foo$<$tt$>$Runs everything in test suiteFoo\+Test{\ttfamily except}Foo\+Test.\+Bar$<$tt$>$and everything in test suiteBar\+Test{\ttfamily except}Bar\+Test.\+Foo\`{}.
\end{DoxyItemize}}

{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md134}{}\doxysubsubsection{Stop test execution upon first failure}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md134}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md135}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md135}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md136}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md136}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md137}{}\doxysubsection{Repeating the Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md137}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md138}{}\doxysubsection{Shuffling the Tests}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md138}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md139}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md139}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md140}{}\doxysubsection{Controlling Test Output}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md140}
{\itshape  }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md141}{}\doxysubsubsection{Colored Terminal Output}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md141}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md142}{}\doxysubsubsection{Suppressing test passes}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md142}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md143}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md143}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md144}{}\doxysubsubsection{Suppressing U\+T\+F-\/8 Text Output}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md144}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md145}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md145}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md146}{}\doxysubsubsection{Generating a J\+S\+O\+N Report}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md146}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md147}{}\doxysubsection{Controlling How Failures Are Reported}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md147}
{\itshape  }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md148}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md148}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md149}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md149}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md150}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md150}
...
{\itshape }\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md151}{}\doxysubsection{Sanitizer Integration}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_advanced_autotoc_md151}
