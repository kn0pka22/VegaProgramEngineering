\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md256}{}\doxysubsection{When I call a method on my mock object, the method for the real object is invoked instead. What\textquotesingle{}s the problem?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md256}
In order for a method to be mocked, it must be {\itshape virtual}, unless you use the \href{gmock_cook_book.md\#MockingNonVirtualMethods}{\texttt{ high-\/perf dependency injection technique}}.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md257}{}\doxysubsection{Can I mock a variadic function?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md257}
...
Ellipsis arguments are inherited from C and not really a C++ feature. They are unsafe to use and don\textquotesingle{}t work with arguments that have constructors or destructors. Therefore we recommend to avoid them in C++ as much as possible.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md258}{}\doxysubsection{M\+S\+V\+C gives me warning C4301 or C4373 when I define a mock method with a const parameter. Why?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md258}
...
Since making a parameter {\ttfamily const} is meaningless in the method declaration, we recommend to remove it in both {\ttfamily Foo} and {\ttfamily Mock\+Foo}. That should workaround the VC bug.
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md259}{}\doxysubsection{I can\textquotesingle{}t figure out why g\+Mock thinks my expectations are not satisfied. What should I do?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md259}
...
return type has no default value set.\char`\"{}, then try \href{gmock_cheat_sheet.md\#OnCall}{\texttt{ adding a default action}}. Due to a known issue, unexpected calls on mocks without default actions don\textquotesingle{}t print out a detailed comparison between the actual arguments and the expected arguments.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md260}{}\doxysubsection{My program crashed and $<$tt$>$\+Scoped\+Mock\+Log$<$/tt$>$ spit out tons of messages. Is it a g\+Mock bug?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md260}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md261}{}\doxysubsection{How can I assert that a function is N\+E\+V\+E\+R called?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md261}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md262}{}\doxysubsection{I have a failed test where g\+Mock tells me T\+W\+I\+C\+E that a particular expectation is not satisfied. Isn\textquotesingle{}t this redundant?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md262}
...
By changing {\ttfamily $\sim$\+Base()} to virtual, {\ttfamily $\sim$\+Derived()} will be correctly called when {\ttfamily delete p} is executed, and the heap checker will be happy.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md264}{}\doxysubsection{The \char`\"{}newer expectations override older ones\char`\"{} rule makes writing expectations awkward. Why does g\+Mock do that?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md264}
...
Back to the original questions\+: why does g\+Mock search the expectations (and {\ttfamily O\+N\+\_\+\+C\+A\+LL}s) from back to front? Because this allows a user to set up a mock\textquotesingle{}s behavior for the common case early (e.\+g. in the mock\textquotesingle{}s constructor or the test fixture\textquotesingle{}s set-\/up phase) and customize it with more specific rules later. If g\+Mock searches from front to back, this very useful pattern won\textquotesingle{}t be possible.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md265}{}\doxysubsection{g\+Mock prints a warning when a function without E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L is called, even if I have set its behavior using O\+N\+\_\+\+C\+A\+L\+L. Would it be reasonable not to show the warning in this case?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md265}
...
Also, you can control the verbosity by specifying {\ttfamily -\/-\/gmock\+\_\+verbose=error}. Other values are {\ttfamily info} and {\ttfamily warning}. If you find the output too noisy when debugging, just choose a less verbose level.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md266}{}\doxysubsection{How can I delete the mock function\textquotesingle{}s argument in an action?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md266}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md267}{}\doxysubsection{How can I perform an arbitrary action on a mock function\textquotesingle{}s argument?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md267}
...
\end{DoxyCode}
\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md268}{}\doxysubsection{My code calls a static/global function. Can I mock it?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md268}
...
This Google Testing Blog \href{https://testing.googleblog.com/2008/06/defeat-static-cling.html}{\texttt{ post}} says it excellently. Check it out.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md269}{}\doxysubsection{My mock object needs to do complex stuff. It\textquotesingle{}s a lot of pain to specify the actions. g\+Mock sucks!}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md269}
...
See this \href{gmock_cook_book.md\#mocking-side-effects}{\texttt{ recipe}} for more details and an example.\hypertarget{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md273}{}\doxysubsection{I have a huge mock class, and Microsoft Visual C++ runs out of memory when compiling it. What can I do?}\label{md__home_mary_VegaProgramEngineering_2024_build__deps_googletest-src_docs_gmock_faq_autotoc_md273}
